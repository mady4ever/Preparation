/*
  Do the post order traversal so that childrens are processed first and then parent.
  while cheking the parent check the left and right childrens and verify the max size of bst. 
