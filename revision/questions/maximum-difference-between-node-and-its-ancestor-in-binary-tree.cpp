/*
  ...
  Find the difference between root node and ancestors.
  return the leaf nodes values from bottom up manner
  also check the difference between root - min(from bottom tree)
*/
